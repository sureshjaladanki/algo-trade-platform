...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run backtest using the latest MLflow model")
    ...
    run_backtest_pipeline(data_dir, symbols_config_path, training_config_path, args.test_period)
