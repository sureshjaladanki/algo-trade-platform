...
class ShortStrategy(TradeStrategy):
    ...
    def check_entry(self, data):
        ...
        price_above_vwma_macro_fast = data['close'] > data.get(self.vwma_macro_fast_key, float('inf'))
        price_above_vwma_macro_slow = data['close'] > data.get(self.vwma_macro_slow_key, float('inf'))

        return safe_for_intraday_positions and safe_for_short and micro_trend_down and pullback and price_above_vwma_macro_fast and price_above_vwma_macro_slow
