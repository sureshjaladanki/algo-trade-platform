...
**Status:** **BLUEPRINT Rev 1.1** — W0, W2, R0 measured. Vehicle dated **CSUS+VXUA 60/40**. **R1 still waits on W1.** Nothing else to run on this desk until W1 returns. All statutory rates remain **working**, not a filed opinion.
**Date:** 2026-09-14 (Rev 1.1; Rev 1.0 was 2026-09-13)
...
**Now (2026-09-14).** W0 saving **22.04 bps/yr** ([w0-wrapper-arithmetic.md](../archive/w0-wrapper-arithmetic.md)). W2 synthetic US-leg **20.6 bps/yr**, permitted ≤ 50% of the US leg ([w2-synthetic-vs-physical.md](../archive/w2-synthetic-vs-physical.md)). R0 step-up **180 bps** of capital on the household working mark, N9 passed ([r0-embedded-gain.md](../archive/r0-embedded-gain.md)). Core vehicle dated **CSUS (IE00B52SFT06) 60% + VXUA (IE0009A5ADV9) 40%**, USD Acc on LSE ([gl2-core-composition.md](../archive/gl2-core-composition.md) §5). Latest safe R1 trade date **17 Mar 2028** ([gl0-cliff-calendar.md](../archive/gl0-cliff-calendar.md)). Term life: MassMutual **$1,000,000** since 2022, only policy, kept with or without PEAD → incremental **$0**. Size covers Table A. 706-NA enforceability open. **Not a W3 pass. N5 stays $60,000.** **W1 is the only remaining gate before R1.** Do not start N0 remainder, W3 scoring, E0, or R1. Do not draft the opinion.
...
3. **Price the tail.** Term life cover sized to Table A, **incremental** premium treated as a cost of the sleeve. Indicatively 3–10 bps/yr of the book at the relevant coverage — cheaper than the wrapper saving — but contingent on health, on jurisdiction, and on the payout reaching the estate in time. **This is the only lever that can lift exit 2's $60,000 cap, and it is therefore the only lever that can make an active sleeve large enough to matter.** It becomes milestone W3. **A MassMutual policy already exists (in force since 2022): face $1,000,000, premium ~$1,300/yr, only life policy, kept with or without PEAD.** Face covers Table A. Incremental sleeve cost **$0**. 706-NA enforceability is not dated. That does not pass W3 and does not lift N5.
...
>
> **Dated vehicle (GL2, 2026-09-14): CSUS 60% + VXUA 40%.** W0's CSPX+XUSE 70/30 remains the arithmetic comparison line, not this book's vehicle. W1 still gates the trade.
...
- **Instrument.** **Dated (GL2, 2026-09-14):** Irish-domiciled, accumulating, USD-denominated UCITS on LSE — **CSUS (IE00B52SFT06) 60% + VXUA (IE0009A5ADV9) 40%.** W0's arithmetic line remains CSPX+XUSE 70/30; VWRA was the permitted single-line substitute and was not chosen. Horizon: permanent.
- **Effect size.** W0 measured **22.04 bps/yr** recurring on the 70/30 arithmetic pair (N9 ≥ 15). Plus removal of a **24.5%-of-book** contingent estate liability (working $500k cell), plus ~11 bps/yr of avoided Indian dividend tax after the cliff, plus the elimination of annual FTC filing. Verified by **arithmetic** against published TERs, published treaty rates, and the funds' own audited withholding disclosures — **not** by a statistical peek. The 23.5 bps in §0.2 Table B is the working derivation; W0 replaces it for this desk.
...
- **Instrument.** Whatever the book holds, sold and repurchased in the same wrapper, with all proceeds received in the US account. Best executed **as one transaction with the domicile switch into CSUS+VXUA**, so the desk crosses the spread once. **W1 must precede it.** Latest safe trade date **17 Mar 2028**.
- **Effect size — measured at R0, 11 Sep 2026 working mark.** Vanguard taxable book: cost **$307,061.36**, value **$354,097.28**, unrealised **$47,035.92** ≈ ₹45.01 lakh. Step-up worth **180 bps** of current INR capital at 13.0% / ~31.2% (≥ 100, N9 passed). FX accretion is **₹0** on this working mark (one rate on both legs). The Rev 1.0 illustration (200k → 400k, INR 62 → 92, ~863 bps) is **retired** — this book was bought from Jul 2025. Detail: [r0-embedded-gain.md](../archive/r0-embedded-gain.md).
