...
| **Live charter** | [india-equity-architecture-blueprint-rev2.md](../next/india-equity-architecture-blueprint-rev2.md) · milestone map [§13](../next/india-equity-architecture-blueprint-rev2.md#13-twelve-month-staged-build) |
| **Branch** | `in-equity` |

This plan implements **superseded** Rev 1.0. Do not start a milestone from it. The live India
milestone map is [Rev 2.0 §13](../next/india-equity-architecture-blueprint-rev2.md#13-twelve-month-staged-build).
...
*Superseded 2026-09-14 together with Rev 1.0. Live charter: [india-equity-architecture-blueprint-rev2.md](../next/india-equity-architecture-blueprint-rev2.md).*
