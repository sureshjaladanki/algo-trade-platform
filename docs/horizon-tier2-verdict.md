...
**Escalation (2026-08-11):** Tier 1 Regime search **CLOSED** ([A0 stop memo](archive/regime-tier1-stop-memo.md)) — Regime is a frozen soft overlay; **Horizon is active** for path quality / selection.
