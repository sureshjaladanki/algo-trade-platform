...
class TestStrategyEngine(unittest.TestCase):
    ...
    def test_init_data(self, mock_get_volume_profile, mock_get_atr, mock_load_config):
        ...
        self.mock_data_adapter.build_1d_candles_history_dataframe.return_value = mock_1d_df
        self.mock_data_adapter.build_1m_candles_history_dataframe.return_value = mock_1m_df
    ...
    def test_on_1m_candle_closed(self, mock_load_config):
        ...
        engine.symbol_dataframes['AAPL'] = pd.DataFrame({'close': [150]}, index=[initial_time])
    ...
    def test_run(self, mock_generate_signals, mock_trade_features, mock_regime_features, mock_init_data, mock_load_config):
        mock_load_config.return_value = self.mock_config
